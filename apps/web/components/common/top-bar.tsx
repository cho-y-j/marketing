...
export function TopBar() {
  return (
    <header className="h-14 border-b border-border-primary bg-surface/80 backdrop-blur-xl sticky top-0 z-30 flex items-center gap-2 px-3 md:px-6 min-w-0">
      {/* 모바일 로고 — 공간 부족 시 축소 */}
      ...
      {/* 매장 선택 — 가운데 영역 flex-1 로 남는 공간 차지 */}
